...
/*   Updated: 2023/08/29 18:37:12 by jmatas-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ft_think(t_philo *philo, int status)
{
    ...
    time_stop_thinking = (philo->table->time_to_die - ft_get_cur_time(philo->table)
...
void    ft_eat(t_philo *philo)
{
    ...
    pthread_mutex_unlock(&philo->last_eat_mutex);
    time_stop_eating = ft_get_cur_time(philo->table) + philo->table->time_to_eat;
